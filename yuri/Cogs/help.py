...
class Help(client.Cog):#Class thing no touchy!!!111
    ...
    async def help(self,ctx): 
        if ctx.guild.id not in conf.act2:
            ...
            e3.add_field(name="y_ask", value="You can ask me a yes-or-no question if you'd like, but please don't be disappointed if I don't know the answer or even give an incorrect one...", inline=True)
            e3.add_field(name="y_feed", value="You can use this to feed me any of the food emojis available. *(Format like this: 'y_feed :food_emoji:')*", inline=True)
            e3.add_field(name="y_headpat", value="You can use this to pat me on the head.", inline=True)
            e3.add_field(name="y_hug", value="I-I'm not too much of a hugger, but if you want me to hug you or someone else on the server, then I suppose I can do that. Simply leave it blank if you want me to hug you, or @mention someone immediately after to have me hug them.", inline=True)
