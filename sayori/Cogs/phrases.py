...
class Commands(client.Cog):#Class thing no touchy!!!111
    ...
    async def commands(self,ctx): 
        e = discord.Embed(title="Commands!", description="Here are all the words/phrases you can use when you @mention me! Though it's ***VERY*** important that the @mention is at the very beginning!", color=0x3eb0ff)
